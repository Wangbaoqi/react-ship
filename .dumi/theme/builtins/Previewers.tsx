...
const Previewer: React.FC<IPreviewerProps> = oProps => {
  ...
  return (
    ...
    >
      {props.iframe && <div className="sp-previewer-browser-nav" />}
      <div
        ref={demoRef}
        className="sp-previewer-demo"
        style={{
      ...
      <div className="sp-previewer-desc" data-title={props.title}>
      ...
      <div className="sp-previewer-actions">
        {actionBarRender(
          <>
            {openCSB && (
              <button
            ...
            <button
              ...
              className={`sp-icon${showSource ? ' sp-btn-expand' : ''}`}
              role="source"
              type="button"
      ...
      {showSource && (
        <div className="sp-previewer-source-wrapper">
          {!isSingleFile && (
            <Tabs
              className="sp-previewer-source-tab"
              prefixCls="sp-tabs"
              moreIcon="···"
          ...
          <div className="sp-previewer-source">
