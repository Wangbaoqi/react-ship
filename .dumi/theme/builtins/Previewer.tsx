...
import Previewers from './Previewers';
...
export default (props: IPreviewerProps) => {
  ...
  useEffect(() => {
    ...
    const isFirstDemo = document.querySelector('.sp-mobile-previewer') === ref.current;
  ...
  return (
    <div
      className={meta.mobile !== false ? 'sp-mobile-previewer' : null}
      onClick={() => {
        if (isInactive) {
          activeSelf();
        }
