...
const Dark: FC<darkProps> = ({ darkSwitch, onDarkSwitchClick, isSideMenu }) => {
      ...
      case 'dark':
        return (
          <button
            ...
            className={`sp-dark-moon ${baseColor === prefersColor ? 'sp-dark-switch-active' : ''}`}
          >
            {moonSvg}
          </button>
        );
      case 'light':
        return (
          <button
            ...
            title="Light theme"
            onClick={(ev) => changeColor(ev, baseColor)}
            className={`sp-dark-sun ${baseColor === prefersColor ? 'sp-dark-switch-active' : ''}`}
          >
            {sunSvg}
          </button>
        );
      case 'auto':
        return (
          <button
            ...
            onClick={(ev) => changeColor(ev, baseColor)}
            className={`sp-dark-auto ${baseColor === prefersColor ? 'sp-dark-switch-active' : ''}`}
          >
            {autoSvg}
          </button>
        );
  ...
  return (
    <div className="sp-dark">
      <div className={`sp-dark-switch ${!isSideMenu && darkSwitch ? 'sp-dark-switch-open' : ''}`}>
        {color == 'dark' ? (
          <button
            key="dumi-dark-btn-moon"
            title="Dark theme"
            onClick={(ev) => changeColor(ev, 'light')}
            className={`sp-dark-moon ${
              prefersColor === prefersColor ? 'sp-dark-switch-active' : ''
            }`}
          >
            {moonSvg}
          </button>
          ...
          <button
            key="dumi-dark-btn-sun"
            title="Light theme"
            onClick={(ev) => changeColor(ev, 'dark')}
            className={`sp-dark-sun ${
              prefersColor === prefersColor ? 'sp-dark-switch-active' : ''
            }`}
          >
            {sunSvg}
