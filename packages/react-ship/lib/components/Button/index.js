...
var Button = function Button(props) {
  ...
  var is_outline = (0, _react.useMemo)(function () {
    return outline !== null && outline !== void 0 ? outline : false;
  }, [outline]);
  var is_block = (0, _react.useMemo)(function () {
    return block !== null && block !== void 0 ? block : false;
  }, [block]);
  var is_shape = (0, _react.useMemo)(function () {
  ...
  var cls = (0, _classnames.default)(className, 'sp-btn', (_cn = {}, _defineProperty(_cn, "sp-btn-".concat(type), type), _defineProperty(_cn, "sp-btn-".concat(size), size), _defineProperty(_cn, 'sp-btn-disabled', disabled), _defineProperty(_cn, 'sp-btn-outline', is_outline), _defineProperty(_cn, 'sp-btn-block', is_block), _defineProperty(_cn, 'sp-btn-shape', is_shape), _cn));
  ...
  var content = function content() {
    if (type === 'link' && href) {
      return /*#__PURE__*/_react.default.createElement("a", _objectSpread({
        href: href
      }, rest), children);
    }
